...
df_ELEM_supp5 = make_df(n_tot = n_supp, teacher_susp = c(.33,1),
                       ...
                       p_asymp_adult = .2, p_asymp_child = 0, mult_asymp = .5,
                       p_subclin_adult = .2, p_subclin_child = .8,
                       teacher_susp = 1, start_type = "teacher",
                       n_other_adults = 30, n_class = 5)
...
file.remove(list.files())
df_HS_supp5 = make_df(n_tot = n_supp, teacher_susp = c(.33,1),
                      start_type = "mix", child_susp = 1,
                      n_class = 16, high_school = T)
...
file.remove(list.files())
df_ELEM = make_df(n_tot = 1, start_type = "cont", n_HH = c(0, 2, 5, 10),
...
#file.remove(list.files())
df_HS = make_df(n_tot = 100, n_class = 16, high_school = T, n_HH = c(0, 2, 5, 10),
                start_type = "cont",
                scenario = c("Base case", "A/B (2)", "Remote"), teacher_susp = 1,
                prob = c(1,10,25,50,100)*3/100000, time = 60)
set.seed(3232)
