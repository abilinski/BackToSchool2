...
#SBATCH -t 0-30:00 # (D-HH:MM) 8 for model setting
...
R CMD BATCH --quiet --no-restore --no-save "--args test_q=$1 notify_val=$2 test_q_isolate=$3 vax_eff_val=$4 version=$5" Middle.R test2.out