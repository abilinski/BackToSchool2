...
#setwd(paste0(wd, "Elementary"))
#file.remove(list.files())

df_ELEM = make_df(attack = .02, n_tot = n_tot, start_type = "cont", n_HH = 2,
...
df_ELEM = rbind(df_ELEM, df_ELEM_ADD, df_ELEM1, df_ELEM2, df_SENS1, df_SENS2, df_SENS3, df_SENS4, df_SENS5) %>% mutate(i = row_number())
